...
elseif(_icu_platform STREQUAL "LINUX")
    # Linux: Add flags to ensure assembly compatibility with clang
    list(APPEND _icu_configure_args "CFLAGS=-fPIC -O2 -fno-integrated-as")
    list(APPEND _icu_configure_args "CXXFLAGS=-fPIC -O2 -fno-integrated-as")
    list(APPEND _icu_configure_args "ASFLAGS=-fno-integrated-as")
    # Force Linux-specific settings to override any macOS environment variables
    list(APPEND _icu_configure_args "LDFLAGS=-fuse-ld=lld")
endif()
